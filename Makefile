...
submit/example:
	LD_LIBRARY_PATH=/usr/lib/chromium-browser oj --webdriver ${WEBDRIVER} s -y 'https://community.topcoder.com/tc?module=MatchDetails&rd=16997' -l C++ ${PROBLEM}.cpp --open
submit/full:
	LD_LIBRARY_PATH=/usr/lib/chromium-browser oj --webdriver ${WEBDRIVER} s -y 'https://community.topcoder.com/tc?module=MatchDetails&rd=16997' -l C++ ${PROBLEM}.cpp --open --full-submission
